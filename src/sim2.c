...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/12/07 15:45:23 by rafael-m          #+#    #+#             */
/*   Updated: 2025/12/07 17:14:58 by rafael-m         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_print_action(const t_philo *philo, const int action)
{
	...
	ft_putlng_fd(ft_get_time() - philo->start_ms, 1);
	write(1, " ms ", 4);
...
int	ft_create_threads(t_philo **philos)
{
	...
	{
		if (pthread_create(&(philos[0]->threads[i]),
				NULL, ft_philo, (void *)philos[i]))
		{
			philos[0]->n_philos = i;
